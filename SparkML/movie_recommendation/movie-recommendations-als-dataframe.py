...
def loadMovieNames():
    ...
    with codecs.open("../../Warmup/ml-100k/u.item", "r", encoding='ISO-8859-1', errors='ignore') as f:
        for line in f:
            fields = line.split('|')
...
#conf = SparkConf().setAppName("YourSparkApplication").set("spark.logConf", "true")
...
# Set the log level to WARN (or your preferred log level)
sc.setLogLevel("WARN") 
